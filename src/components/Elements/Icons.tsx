...
export function Icons({ className, children }: IconsProps) {
	const Component = customs['JavaScript']
...
const customs = {
	JavaScript: () => <svg fill={'none'} height={16} width={16} xmlns="http://www.w3.org/2000/svg"
